...
__all__ = [
    'vbextFileTypeDocObject', '_LinkedWindows', 'vbext_vm_Break',
    'vbext_ProjectType', 'vbext_ct_Document', 'vbextFileTypeFrx',
    'vbext_ComponentType', 'vbextFileTypeClass',
    'vbext_ct_ActiveXDesigner', 'vbext_rk_TypeLib',
    'vbext_ws_Minimize', 'CommandBarEvents', 'Application',
    'vbext_ProjectProtection', '_Properties', '_References',
    '_CodePanes', 'vbext_wt_CodeWindow', 'vbext_pk_Set', 'Events',
    'vbext_pp_none', 'VBProject', 'vbext_WindowType',
    'vbext_ct_ClassModule', '_Component', 'Windows',
    'ReferencesEvents', 'vbext_ws_Normal', 'vbext_vm_Run',
    'vbext_ProcKind', 'vbextFileTypeGroupProject',
    'vbext_ct_StdModule', 'vbext_wt_Toolbox', 'vbext_wt_ToolWindow',
    'VBProjects', '_VBProject', 'vbextFileTypeRes', 'vbext_wt_Watch',
    'vbext_wt_MainWindow', 'vbext_RefKind', 'Components', 'Reference',
    'CodePane', '_dispReferences_Events', 'vbext_wt_ProjectWindow',
    'CodePanes', '_VBComponents', '_CodeModule',
    '_dispCommandBarControlEvents', 'vbext_wt_LinkedWindowFrame',
    'Properties', 'vbext_CodePaneview', 'vbext_cv_ProcedureView',
    'vbext_ct_MSForm', '_VBComponents_Old', 'vbext_wt_Immediate',
    'vbext_wt_Browser', 'vbext_pk_Let', 'vbext_vm_Design',
    'VBComponent', 'vbextFileTypePropertyPage', 'vbext_wt_Locals',
    'VBE', 'References', '_AddIns', '_VBProject_Old', 'vbext_pk_Get',
    'Window', '_Windows_old', 'vbext_wt_PropertyWindow',
    'vbextFileTypeModule', '_dispVBProjectsEvents',
    'vbext_wt_FindReplace', 'vbext_pt_StandAlone',
    '_dispReferencesEvents', 'VBComponents', 'AddIn',
    'vbext_rk_Project', 'vbext_cv_FullModuleView',
    '_VBProjectsEvents', 'vbextFileTypeProject',
    'vbextFileTypeBinary', 'vbext_wt_Find', '_ReferencesEvents',
    '_CodePane', 'vbextFileTypes', 'vbextFileTypeDesigners',
    'vbext_VBAMode', '_VBComponentsEvents', '_VBComponent',
    'vbext_WindowState', 'vbext_pk_Proc', 'vbext_pt_HostProject',
    'SelectedComponents', '_ProjectTemplate',
    'vbextFileTypeUserControl', 'Component', '_Components',
    '_dispVBComponentsEvents', 'vbext_ws_Maximize',
    'vbext_wt_Designer', '_Windows', 'vbextFileTypeExe',
    '_VBProjects_Old', 'LinkedWindows', 'Property', 'CodeModule',
    '_CommandBarControlEvents', 'Addins', '_VBComponent_Old',
    '_VBProjects', 'vbext_pp_locked', 'vbextFileTypeForm',
    'ProjectTemplate'
]

_check_version('1.2.0', 1438223560.000000)
